...
class CommandRunner {
  ...
  //This allows users of your package to define their own error-handling logic.
  //type means it's a function that takes an Object and returns a Future or nothing, and it might be null.
